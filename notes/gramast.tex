...
Derzeit werden DAOs, entweder von einer einzelnen Schlüsselperson, einer Organisation (wie bei Bitcoin die "Bitcoin-Foundation") oder einem Unternehmen (wie bei Ethereum "Ethereum Switzerland GmbH") entwickelt und manipuliert. Trotz der dezentralen natur der DAOs ist die Kontrolle über diese noch Zentralisiert. 
...
\TODO[inline]{ethereum gmbh und bitcoin foundation verlinken}
...
\TODO[inline]{muss diese strickte Totalordnung auch ein element von O sein?}
...
% Die Kandidatenmenge ergibt sich durch die Kombinationen der Präfixe mit den Optionen einer Optionsmenge.
...
\TODO[inline]{hier ist der delimiter \& notwendig}
$
\begin{array}{rl}
  S_1(G) :=& (N', T', S, P') \\
...
\TODO[inline]{reduziere Tire serialisierung auf Baumserialisierung von Paper xy}
...
\TODO[inline]{wichtig ist das jede mögliche bewertung $vote$ in der codierung möglich ist.}
...
\TODO[inline]{number, float etc als elemente einer menge beschreibennumber, float etc als elemente einer menge beschreiben}
