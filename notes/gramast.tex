...
Jedoch gibt es Argumente dafür, dass die Blockchain das Problem der Byzantinischen Generäle nicht vollständig löst:
...
Ein Beispiel für eine interne DAO ist eine dezentrale Währung, wie sie derzeit vom Bitcoin repräsentiert wird (Quelle \cite{Butterin2014}). Sie ist in Abbildung \ref{contract1} illustriert. Ein weiteres Beispiel in Abbildung \ref{contract2} ist ein dezentrales DNS System, wie ihn die Namecoin DAO implementiert.
...
\textbf{Im folgenden wird ein Vorschlag einer solchen Schicht vorstellen. Hierfür werden als Erstes die theoretischen Komponenten betrachten, anschließend ihre Anwendung auf die regulären Grammatiken und schließlich ihre Implementation.}
