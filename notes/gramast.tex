...
\TODO[inline]{strickte Totalordnung der Kandidaten mit in die DAO definition einbauen}
...
% Zentralisierte Implementation
% Ignorierung der Dezentralisierungsschicht
% durch die Turing vollständigkeit kann diese auf die ethereum chain portiert werden
\subsection*{Architektur}
\subsubsection*{Client/Server Architektur/ Interaktion}
% Grafik der interaktion
% Implementiert ist der in DAO - Interaktion
% Akteur kann
%   DAO erstellen
%     initialfunktion
%   DAO valide Manipulieren
%   sign -> send to server
%   server sign check + valide manipulation -> new consens
%   send consens to client
...
% JISON - http://zaach.github.io/jison/docs/
%   LALR(1) 
%     Subset of CFG
%     S(G) is in LALR(1)
%   BISON - Parser Generator - http://de.wikipedia.org/wiki/GNU_Bison
% Architecture
%   Extention - Pseudocode
%   Metaword to Parse Tree (PT)
%   PT - functions
